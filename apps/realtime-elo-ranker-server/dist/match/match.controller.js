...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Résultats du match publiés avec succès' }),
    (0, swagger_1.ApiResponse)({ status: 422, description: "Soit le gagnant, soit le perdant indiqué n'existe pas" }),
